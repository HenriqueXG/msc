...
var QueryList = /** @class */ (function (_super) {
    ...
    function QueryList(props, context) {
        ...
        _this.renderCreateItemMenuItem = function (query) {
            ...
            return core_1.Utils.safeInvoke(_this.props.createNewItemRenderer, query, isActive, handleClick);
        };
        _this.handleItemCreate = function (query, evt) {
            ...
            var item = core_1.Utils.safeInvoke(_this.props.createNewItemFromQuery, query);
            if (item != null) {
        ...
        var createNewItem = core_1.Utils.safeInvoke(props.createNewItemFromQuery, query);
    ...
    QueryList.prototype.setQuery = function (query, resetActiveItem, props) {
        ...
        if (hasQueryChanged) {
            core_1.Utils.safeInvoke(props.onQueryChange, query);
        }
        var filteredItems = getFilteredItems(query, props);
    ...
    QueryList.prototype.setActiveItem = function (activeItem) {
        ...
        if (common_1.isCreateNewItem(activeItem)) {
            core_1.Utils.safeInvoke(this.props.onActiveItemChange, null, true);
        }
        else {
            core_1.Utils.safeInvoke(this.props.onActiveItemChange, activeItem, false);
        }
    };

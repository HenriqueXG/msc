...
export declare class MultiSlider extends AbstractPureComponent2<IMultiSliderProps, ISliderState> {
    ...
    static getDerivedStateFromProps(props: IMultiSliderProps): {
        labelPrecision: number;
    };
    ...
    getSnapshotBeforeUpdate(prevProps: IMultiSliderProps): null;
    render(): JSX.Element;
    componentDidMount(): void;
    componentDidUpdate(prevProps: IMultiSliderProps, prevState: ISliderState, ss: {}): void;
    protected validateProps(props: React.PropsWithChildren<IMultiSliderProps>): void;
    private formatLabel;
